...
@Component({
  selector: 'app-purchase-report-detail',
  templateUrl: './purchase-report-detail.component.html',
  styleUrls: ['./purchase-report-detail.component.css']
})
export class PurchaseReportDetailComponent {
  ...
  fetchPurchaseBillInfoForReport(billNo: number) {
    this.purchaseBillService.fetchPurchaseBillInfoForReport(billNo, this.companyId, this.branchId).subscribe((res => {
